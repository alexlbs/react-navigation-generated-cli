        ...
        var onExpoData_1 = function (data) {
            ...
            if (!startMarkerFound_1) {
                ...
                if (startIndex >= 0) {
                    ...
                    output = output.substring(0, startIndex - lastDataTail_1.length + START_IDENTIFIER.length) + '\n[json removed]\n';
                }
            }
            else {
            ...
            if (startMarkerFound_1) {
                ...
                if (endIndex >= 0) {
                    ...
                    dataIsReady = true;
                    output = collectedOutput_1.substr(endIndex); // we should print data after end marker
                ...
                try {
                    ...
                    try {
                        for (var lines_1 = __values(lines), lines_1_1 = lines_1.next(); !lines_1_1.done; lines_1_1 = lines_1.next()) {
                            ...
                            var ok = output.match(/REACT_NAVIGATION_GENERATED_OUTPUT:(.*)/);
                            if (ok) {
                                routeMapString += ok[1];
                            }
                        }
